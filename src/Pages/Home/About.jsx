...
<h1 className='text-center about-heading ' data-aos="fade-down-right">About Us</h1>
...
<Link to="/About" className='btn btn-primary'  data-aos="fade-down-right">Read More</Link>

        </div>
        <div className="col-lg-6 col-md-12 mt-3">

<img src={img1} width={650} height={450} alt="img-fluid" className='col-md-12 about-img' data-aos="fade-down-left" />
