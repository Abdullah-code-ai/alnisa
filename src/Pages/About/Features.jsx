...
const Features = () => {
    const features = [
        { title: 'Free Trial Classes', description: 'Get 3 free trial classes for any course of your choice to evaluate our tutors and courses.' , image: `${img}` },
...
useEffect(() => {
  ...
  return (
    ...
    <div className="container mt-3 mb-3">
        <h1 className='text-center heading-text mb-3'>AL-NISA QURAN INSTITUTE Features
        </h1>
    </div>
    <div className="feature-card-container mt-5" data-aos="zoom-in">
