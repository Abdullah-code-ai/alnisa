   ...
   <footer className='mt-5'>
        ...
        <div className="footer-col">
          ...
          <div className="links">
            ...
            <a href="#s"><i className="fab fa-linkedin-in" /></a>
            <a href="#s"><i className="fab fa-facebook-f" /></a>
            <a href="#s"><i className="fab fa-twitter" /></a>
            <a href="#s"><i className="fab fa-instagram" /></a>
          </div>
        </div>
